...
int Sensor :: checkrotation(){
  if((rawAngle_sub >= -1034&&rawAngle_sub <= -1014)||(rawAngle_sub >= 3062&&rawAngle_sub <= 3082)){
    //面朝魔方面沿顺时针方向转90度恢复
    return 1;
  }else if((rawAngle_sub >= 1014&&rawAngle_sub <= 1034)||(rawAngle_sub >= -3082&&rawAngle_sub <= -3062)){
    //面朝魔方面沿逆时针方向转90度恢复
    return 2;
  }else if((rawAngle_sub >= -2058&&rawAngle_sub <= -2038)||(rawAngle_sub >= 2038&&rawAngle_sub <= 2058)){
    //面朝魔方面沿顺时针方向转180度恢复
    return 3;
  }else{
    //不旋转
