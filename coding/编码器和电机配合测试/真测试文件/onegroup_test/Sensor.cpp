...
int Sensor :: checkrotation(){
  if((rawAngle_sub >= -1224&&rawAngle_sub <= -824)||(rawAngle_sub >= 2872&&rawAngle_sub <= 3272)){
    //面朝魔方面沿顺时针方向转90度恢复
    return 1;
  }else if((rawAngle_sub >= 824&&rawAngle_sub <= 1224)||(rawAngle_sub >= -3272&&rawAngle_sub <= -2872)){
    //面朝魔方面沿逆时针方向转90度恢复
    return 2;
  }else if((rawAngle_sub >= -2248&&rawAngle_sub <= -1848)||(rawAngle_sub >= 1848&&rawAngle_sub <= 2248)){
    //面朝魔方面沿顺时针方向转180度恢复
    return 3;
  }else{
    //不旋转
