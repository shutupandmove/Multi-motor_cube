...
int Sensor :: checkrotation(){
  if((rawAngle_sub >= -1324&&rawAngle_sub <= -724)||(rawAngle_sub >= 2772&&rawAngle_sub <= 3372)){
    //面朝魔方面沿顺时针方向转90度恢复
    return 1;
  }else if((rawAngle_sub >= 724&&rawAngle_sub <= 1324)||(rawAngle_sub >= -3372&&rawAngle_sub <= -2772)){
    //面朝魔方面沿逆时针方向转90度恢复
    return 2;
  }else if((rawAngle_sub >= -2348&&rawAngle_sub <= -1748)||(rawAngle_sub >= 1748&&rawAngle_sub <= 2348)){
    //面朝魔方面沿顺时针方向转180度恢复
    return 3;
  }else{
    //不旋转
